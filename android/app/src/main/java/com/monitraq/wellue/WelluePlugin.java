...
@CapacitorPlugin(name = "WellueSDK", permissions = {
...
public class WelluePlugin extends Plugin {
    ...
    private final Runnable connPoller = new Runnable() {
        ...
        public void run() {
            try {
                ...
                if (manager != null) {
                    java.util.List<android.bluetooth.BluetoothDevice> list = manager
    ...
    private void ensureDiscoveryObserver() {
        if (discoveryObserverRegistered)
            return;
        try {
            LiveEventBus.get(EventMsgConst.Discovery.EventDeviceFound, Bluetooth.class)
                    .observeForever(bt -> {
                        try {
                            if (bt == null)
                                return;
                            Log.d(TAG, "🔎 EventDeviceFound: name=" + bt.getName() + ", model=" + bt.getModel()
                                    + ", addr=" + (bt.getDevice() != null ? bt.getDevice().getAddress() : "null"));
                            JSObject dev = new JSObject();
    ...
    private void ensureBp2DebugObservers() {
        if (bp2DebugObserversRegistered)
            return;
        try {
            ...
            for (java.lang.reflect.Field f : bp2Cls.getDeclaredFields()) {
                ...
                try {
                    LiveEventBus.get(observeKey, Object.class).observeForever(obj -> {
                        try {
                            Log.d(TAG, "🔔 BP2 Event: " + observeKey + ", payloadClass="
            ...
            for (java.lang.reflect.Method m : obj.getClass().getMethods()) {
                try {
                    ...
                    if (v instanceof float[])
                        extra = " len=" + ((float[]) v).length;
                    else if (v instanceof short[])
                        extra = " len=" + ((short[]) v).length;
                    else if (v instanceof int[])
                        extra = " len=" + ((int[]) v).length;
                    else if (v instanceof double[])
                        extra = " len=" + ((double[]) v).length;
        ...
        try {
            ...
            LiveEventBus.get(key, Object.class).observeForever(new Observer<Object>() {
                ...
                public void onChanged(Object obj) {
                    try {
                        Log.d(TAG,
                                "📡 BP2 Rt event received class=" + (obj != null ? obj.getClass().getName() : "null"));
                        Object payload = obj;
                        // Unwrap common wrappers
                        if (payload != null) {
                            String[] unwrap = new String[] { "getObj", "getData", "getPayload", "getSecond",
                                    "component2" };
                            for (String m : unwrap) {
                                try {
                        ...
                        if (payload != null) {
                            // Top-level fields
                            try {
                                Object v = payload.getClass().getMethod("getDeviceStatus").invoke(payload);
                                if (v instanceof Number)
                                    deviceStatus = ((Number) v).intValue();
                            } catch (Throwable ignore) {
                            }
                            try {
                                Object v = payload.getClass().getMethod("getBatteryStatus").invoke(payload);
                                if (v instanceof Number)
                                    batteryStatus = ((Number) v).intValue();
                            } catch (Throwable ignore) {
                            }
                            try {
                                Object v = payload.getClass().getMethod("getPercent").invoke(payload);
                                if (v instanceof Number)
                                    percent = ((Number) v).intValue();
                            } catch (Throwable ignore) {
                            }
                            // RtParam
                            String[] paramNames = new String[] { "getParam", "getRtParam", "getParamData", "getRtData",
                                    "getParams" };
                            for (String pn : paramNames) {
                                try {
                                    java.lang.reflect.Method pm = payload.getClass().getMethod(pn);
                                    Object v = pm.invoke(payload);
                                    if (v != null) {
                                        param = v;
                                        break;
                                    }
                            ...
                            if (dataType == null) {
                                try {
                                    Object v = payload.getClass().getMethod("getParamDataType").invoke(payload);
                                    if (v instanceof Number)
                                        dataType = ((Number) v).intValue();
                                } catch (Throwable ignore) {
                                }
                            }
                            // Extra diagnostics
                        ...
                        if (param != null) {
                            ...
                            try {
                                Object v = param.getClass().getMethod("getParamDataType").invoke(param);
                                if (v instanceof Number)
                                    dataType = ((Number) v).intValue();
                            } catch (Throwable ignore) {
                            }
                            ...
                            for (java.lang.reflect.Method m : param.getClass().getMethods()) {
                                if (m.getParameterCount() == 0 && !m.getName().equals("getClass")
                                    ...
                                    try {
                                        ...
                                        Log.e(TAG, "  📋 PARAM_METHOD: " + m.getName() + "() -> " + result + " (type: "
                                                + (result != null ? result.getClass().getSimpleName() : "null") + ")");
                                    } catch (Throwable e) {
                                        Log.e(TAG,
                                                "  ❌ PARAM_METHOD: " + m.getName() + "() -> Error: " + e.getMessage());
                                    }
                                }
                            }

                            // Try to fetch nested paramData (RtBpIng/RtBpResult/RtEcgIng/RtEcgResult)
                            String[] pdNames = new String[] { "getParamData", "getData", "getBpIng", "getBpResult",
                                    "getEcgIng", "getEcgResult" };
                            for (String pd : pdNames) {
                                try {
                                    java.lang.reflect.Method pm = param.getClass().getMethod(pd);
                                    Object v = pm.invoke(param);
                                    Log.e(TAG, "🔍 Trying " + pd + "() -> " + v + " (type: "
                                            + (v != null ? v.getClass().getName() : "null") + ")");
                                    if (v != null) {
                                        paramData = v;
                                        Log.e(TAG, "✅ PARAM_DATA extracted using " + pd + "() -> type: "
                                                + paramData.getClass().getName());
                                        break;
                                    }
                                } catch (Throwable ignore) {
                            ...
                            Log.e(TAG, "🔍 Final paramData: " + paramData + " (type: "
                                    + (paramData != null ? paramData.getClass().getName() : "null") + ")");
                            // Heart rate candidates (param level)
                            String[] hrNames = new String[] { "getHr", "getHeartRate", "getPr" };
                            for (String hn : hrNames) {
                                try {
                                    Object v = param.getClass().getMethod(hn).invoke(param);
                                    if (v instanceof Number) {
                                        hr = ((Number) v).intValue();
                                        break;
                                    }
                                } catch (Throwable ignore) {
                                }
                                    ...
                                    try {
                                        ...
                                        if (result instanceof Number) {
                                            ...
                                            if (value >= 30 && value <= 200) {
                                                hr = value;
                                                Log.d(TAG, "✅ ECG HR found via RtEcgResult." + methodName + "(): " + hr
                                                        + " BPM");
                                                break;
                                            }
                                        }
                                        ...
                                        if (m.getParameterCount() == 0 && !m.getName().equals("getClass")
                                            ...
                                            try {
                                                ...
                                                if (result instanceof Number) {
                                                    int value = ((Number) result).intValue();
                                                    if (value >= 30 && value <= 200) {
                                                        Log.e(TAG, "  📋 POTENTIAL_HR: " + m.getName() + "() -> "
                                                                + result + " (CANDIDATE FOR ECG HR!)");
                                                    } else {
                                                        Log.e(TAG,
                                                                "  📋 ECG_RESULT_METHOD: " + m.getName() + "() -> "
                                                                        + result + " (type: "
                                                                        + (result != null
                                                    ...
                                                    Log.e(TAG,
                                                            "  📋 ECG_RESULT_METHOD: " + m.getName() + "() -> " + result
                                                                    + " (type: "
                                                                    + (result != null
                                                                            ? result.getClass().getSimpleName()
                                                                            : "null")
                                                ...
                                                Log.e(TAG, "  ❌ ECG_RESULT_METHOD: " + m.getName() + "() -> Error: "
                                                        + e.getMessage());
                                            }
                                        }
                                    }
                                    ...
                                    try {
                                        ...
                                        if (ecgBytes.length >= 4) {
                                            ...
                                            if (hr1 >= 30 && hr1 <= 200) {
                                                ...
                                                Log.w(TAG, "⚠️ ECG HR parsing failed - hr1=" + hr1 + ", hr2=" + hr2
                                                        + " (outside 30-200 range)");
                                            }
                                        }
                                    } catch (Throwable t) {
                            ...
                            if (dataType == null || dataType == 2 || dataType == 3) {
                                ...
                                if (paramData != null)
                                    logIntrospection(paramData, "ℹ️ RtParamData");
                            }
                            ...
                            if (dataType != null && dataType == 2 && !ecgMeasuringActive) {
                                ...
                                Log.e(TAG, "🔍 ECG dataType=3 detected, ecgMeasuringActive=" + ecgMeasuringActive
                                        + ", deviceStatus=" + deviceStatus);
                                // 🚀 FORCE ECG STOP: Always trigger stop event when we get ECG result data
                                // (dataType=3)
                                ...
                                if (hr != null && hr > 0) {
                                    ...
                                    try {
                                        ...
                                        if (paramData instanceof byte[]) {
                                            byte[] ecgBytes = (byte[]) paramData;
                                            Log.e(TAG, "🔍 ECG bytes length: " + ecgBytes.length + ", content: "
                                                    + java.util.Arrays.toString(ecgBytes));
                                            ...
                                            if (ecgBytes.length >= 2) {
                                                ...
                                                if (hrFromBytes >= 30 && hrFromBytes <= 200) {
                                                    realHR = hrFromBytes;
                                                    Log.e(TAG,
                                                            "✅ Real ECG HR found from bytes[0-1]: " + realHR + " BPM");
                                                }

                                                // Strategy 2: Try other byte positions if first didn't work
                                                if (realHR == 0 && ecgBytes.length >= 4) {
                                                    int hrFromBytes2 = ((ecgBytes[3] & 0xFF) << 8)
                                                            | (ecgBytes[2] & 0xFF);
                                                    if (hrFromBytes2 >= 30 && hrFromBytes2 <= 200) {
                                                        realHR = hrFromBytes2;
                                                        Log.e(TAG, "✅ Real ECG HR found from bytes[2-3]: " + realHR
                                                                + " BPM");
                                                    }
                                                }
                                                ...
                                                if (realHR == 0) {
                                                    for (int i = 0; i < ecgBytes.length - 1; i++) {
                                                        int potentialHR = ((ecgBytes[i + 1] & 0xFF) << 8)
                                                                | (ecgBytes[i] & 0xFF);
                                                        if (potentialHR >= 30 && potentialHR <= 200) {
                                                            realHR = potentialHR;
                                                            Log.e(TAG, "✅ Real ECG HR found from bytes[" + i + "-"
                                                                    + (i + 1) + "]: " + realHR + " BPM");
                                                            break;
                                                        }
                                                    }
                                        ...
                                        if (realHR == 0) {
                                            String[] hrMethods = { "getHr", "getHeartRate", "getBpm", "getEcgHr",
                                                    "getFinalHr", "getResultHr" };
                                            for (String methodName : hrMethods) {
                                                try {
                                                    java.lang.reflect.Method method = paramData.getClass()
                                                    ...
                                                    if (result instanceof Number) {
                                                        ...
                                                        if (value >= 30 && value <= 200) {
                                                            realHR = value;
                                                            Log.e(TAG, "✅ Real ECG HR found via reflection: " + realHR
                                                                    + " BPM via " + methodName);
                                                            break;
                                                        }
                                                    }
                                        ...
                                        try {
                                            java.lang.reflect.Method qrsMethod = paramData.getClass()
                                                    .getMethod("getQrsDuration");
                                            Object qrsResult = qrsMethod.invoke(paramData);
                                            if (qrsResult instanceof Number)
                                                realQRS = ((Number) qrsResult).intValue();
                                        } catch (Throwable ignore) {
                                        }

                                        try {
                                            java.lang.reflect.Method qtMethod = paramData.getClass()
                                                    .getMethod("getQtInterval");
                                            Object qtResult = qtMethod.invoke(paramData);
                                            if (qtResult instanceof Number)
                                                realQT = ((Number) qtResult).intValue();
                                        } catch (Throwable ignore) {
                                        }

                                        try {
                                            java.lang.reflect.Method prMethod = paramData.getClass()
                                                    .getMethod("getPrInterval");
                                            Object prResult = prMethod.invoke(paramData);
                                            if (prResult instanceof Number)
                                                realPR = ((Number) prResult).intValue();
                                        } catch (Throwable ignore) {
                                        }

                                        // Try to get rhythm analysis
                                        try {
                                            java.lang.reflect.Method rhythmMethod = paramData.getClass()
                                                    .getMethod("getRhythm");
                                            Object rhythmResult = rhythmMethod.invoke(paramData);
                                            if (rhythmResult instanceof String)
                                                realRhythm = (String) rhythmResult;
                                        } catch (Throwable ignore) {
                                        }
                                    ...
                                    if (realHR > 0) {
                                        ...
                                        Log.e(TAG,
                                                "🔶 ECG lifecycle (paramType=3): FORCE stop with REAL data - HR="
                                                        + realHR + ", QRS=" + realQRS + ", QT=" + realQT + ", PR="
                                                        + realPR + ", Rhythm=" + realRhythm);
                                    } else {
                                        // Last resort: use device-reported HR if available
                                        int fallbackHR = hr != null && hr > 0 ? hr : 90; // Use 90 as default (your
                                                                                         // device reading)
                                        life.put("finalHeartRate", fallbackHR);
                                        Log.e(TAG, "🔶 ECG lifecycle (paramType=3): FORCE stop with fallback HR="
                                                + fallbackHR + " (using device-reported value)");
                                    }
                                }
                                notifyListeners("ecgLifecycle", life);
                                try {
                                    ...
                                    if (helper != null)
                                        helper.getClass().getMethod("stopRtTask", int.class).invoke(helper,
                                                com.lepu.blepro.objs.Bluetooth.MODEL_BP2);
                                } catch (Throwable ignore) {
                                }
                            }
                        }
                        ...
                        try {
                            ...
                            if (sr != null && sr.intValue() > 0 && sr.intValue() < 1000)
                                sampleRate = sr.intValue();
                        } catch (Throwable ignore) {
                        }
                        if (waveSrc != null && (dataType != null && (dataType == 2 || dataType == 3))) {
                            String[] shortNames = new String[] { "getEcgShorts", "getEcgShortData", "getWaveShortData",
                                    "getEcgData", "shorts", "getShorts" };
                            ...
                            if (ecgShorts == null) {
                                String[] floatNames = new String[] { "getEcgFloats", "getWave", "getWaveData",
                                        "getEcgFloatData", "floats", "getFloats" };
                                for (String fn : floatNames) {
                                    try {
                                        java.lang.reflect.Method fm = waveSrc.getClass().getMethod(fn);
                                        Object v = fm.invoke(waveSrc);
                                        if (v instanceof float[]) {
                                            ecgFloats = (float[]) v;
                                            break;
                                        }
                            ...
                            // If still nothing, try raw bytes (observed in logs as getParamData(): [B and
                            // getEcgBytes(): [B)
                            if (ecgShorts == null && ecgFloats == null) {
                                byte[] bytes = null;
                                // Preferred getter names
                                String[] byteNames = new String[] { "getEcgBytes", "getBytes", "getParamData",
                                        "getData" };
                                    ...
                                    try {
                                        if (m.getParameterCount() == 0) {
                                            ...
                                            if (rt.isArray()) {
                                                ...
                                                if (v instanceof float[] && ((float[]) v).length > 0) {
                                                    ecgFloats = (float[]) v;
                                                    break;
                                                }
                                                if (v instanceof short[] && ((short[]) v).length > 0) {
                                                    ecgShorts = (short[]) v;
                                                    break;
                                                }
                                                if (v instanceof int[] && ((int[]) v).length > 0) {
                                                    int[] arr = (int[]) v;
                                                    short[] tmp = new short[arr.length];
                                                    for (int i = 0; i < arr.length; i++)
                                                        tmp[i] = (short) arr[i];
                                                ...
                                                if (v instanceof double[] && ((double[]) v).length > 0) {
                                                    double[] arr = (double[]) v;
                        ...
                        if (deviceStatus != null)
                            rt.put("deviceStatus", deviceStatus);
                        if (batteryStatus != null)
                            rt.put("batteryStatus", batteryStatus);
                        if (percent != null)
                            rt.put("percent", percent);
                        if (dataType != null)
                            rt.put("paramDataType", dataType);
                        if (hr != null)
                            rt.put("hr", hr);
                        // Device status lifecycle events (ECG and BP)
                        if (deviceStatus != null
                                && (lastDeviceStatus == null || !lastDeviceStatus.equals(deviceStatus))) {
                            ...
                            // 🚀 ADDITIONAL ECG STOP TRIGGER: If we have HR data and device status is 7
                            // (even if unchanged)
                            // This handles cases where deviceStatus stays at 7 but we finally get heart
                            // rate data
                            if (deviceStatus != null && deviceStatus.intValue() == 7 && hr != null && hr > 0
                                    && ecgMeasuringActive) {
                                JSObject life = new JSObject();
                                life.put("state", "stop");
                                life.put("finalHeartRate", hr);
                                Log.d(TAG, "🔶 ECG lifecycle: FORCED stop with final HR = " + hr
                                        + " BPM (deviceStatus unchanged but HR found)");
                                notifyListeners("ecgLifecycle", life);
                                ecgMeasuringActive = false;
                                synchronized (ecgLock) {
                                    ecgAccumFloats.clear();
                            ...
                            // BP lifecycle with enhanced state detection
                                ...
                                try {
                                    Object helper = getBleHelper();
                                    if (helper != null) {
                                        helper.getClass().getMethod("startRtTask", int.class).invoke(helper,
                                                com.lepu.blepro.objs.Bluetooth.MODEL_BP2);
                                    ...
                                    Log.e(TAG, "❌ Failed to auto-start RT monitoring for device-initiated measurement",
                                            t);
                                }
                        ...
                        if (dataType != null && dataType.intValue() == 0 && paramData != null) {
                            Log.e(TAG,
                                    "🔴 BP MEASURING IN PROGRESS - paramData type: " + paramData.getClass().getName());

                            Integer pressure = null;
                            String[] pNames = new String[] { "getPs", "getPressure", "getCurPressure",
                                    "getCurrentPressure", "ps" };
                                    ...
                                    try {
                                        ...
                                        if (pressure < 0 || pressure > 400) {
                                            ...
                                            if (pressure < 0 || pressure > 400) {
                                                ...
                                                Log.e(TAG,
                                                        "🔴 PRESSURE Strategy 3 (single byte): " + pressure + " mmHg");
                        ...
                        if (dataType != null && dataType.intValue() == 1 && paramData != null) {
                            ...
                            if (paramData instanceof byte[]) {
                                ...
                                if (bytes.length >= 10) {
                                    try {
                                        ...
                                        if (sys >= 70 && sys <= 250 &&
                                                ...
                                                pr >= 40 && pr <= 180) {
                                            Log.e(TAG,
                                                    "🩺 ✅ VALUES VALIDATED: sys=" + sys + " dia=" + dia + " pr=" + pr);
                                        } else {
                                        ...
                                        if (bytes.length > 6)
                                            resultCode = bytes[6] & 0xFF;
                                        if (resultCode == null || resultCode == 0) {
                                            if (bytes.length > 16)
                                                resultCode = bytes[16] & 0xFF;
                                        }
                                ...
                                for (String[] c : cand) {
                                    try {
                                        Object v = paramData.getClass().getMethod(c[0]).invoke(paramData);
                                        if (v instanceof Number)
                                            sys = ((Number) v).intValue();
                                    } catch (Throwable ignore) {
                                    }
                                    try {
                                        Object v = paramData.getClass().getMethod(c[1]).invoke(paramData);
                                        if (v instanceof Number)
                                            dia = ((Number) v).intValue();
                                    } catch (Throwable ignore) {
                                    }
                                    try {
                                        Object v = paramData.getClass().getMethod(c[2]).invoke(paramData);
                                        if (v instanceof Number)
                                            pr = ((Number) v).intValue();
                                    } catch (Throwable ignore) {
                                    }
                                    try {
                                        Object v = paramData.getClass().getMethod(c[3]).invoke(paramData);
                                        if (v instanceof Number)
                                            map = ((Number) v).intValue();
                                    } catch (Throwable ignore) {
                                    }
                                    if (sys != null || dia != null || pr != null || map != null)
                                        break;
                                }
                                try {
                                    Object v = paramData.getClass().getMethod("getResult").invoke(paramData);
                                    if (v instanceof Number)
                                        resultCode = ((Number) v).intValue();
                                } catch (Throwable ignore) {
                                }
                            }

                            Log.e(TAG, "🩺 FINAL EXTRACTED VALUES: sys=" + sys + " dia=" + dia + " pr=" + pr + " map="
                                    + map + " result=" + resultCode);
                            ...
                            if (map != null && map > 0)
                                ev.put("map", map);
                            if (resultCode != null)
                                ev.put("result", resultCode);

                            // Only send measurement complete events if we have valid BP data AND stop
                            ...
                            if (hasValidData) {
                                ...
                                try {
                                    ...
                                    if (helper != null) {
                                        ...
                                        java.lang.reflect.Method stopRtTaskMethod = helper.getClass()
                                                .getMethod("stopRtTask", int.class);
                                ...
                                if (map != null)
                                    bpLife.put("map", map);
                                notifyListeners("bpLifecycle", bpLife);
                                Log.d(TAG, "🩺 BP lifecycle: complete with valid data [" + sys + "/" + dia + ", HR "
                                        + pr + "]");
                            } else {
                        ...
                        if (ecgMeasuringActive && ((ecgShorts != null && ecgShorts.length > 0)
                                || (ecgFloats != null && ecgFloats.length > 0))) {
                            ...
                            try {
                                if (ecgShorts != null) {
                                    ...
                                    Log.d("BP2_RAW_ECG",
                                            "SampleRate=" + sampleRate + " Hz, mvPerCount=" + scale + ", shortsCount="
                                                    + ecgShorts.length + ", preview=" + Arrays.toString(preview));
                                } else if (ecgFloats != null) {
                                    int prevLen = Math.min(ecgFloats.length, 200);
                                    float[] preview = Arrays.copyOf(ecgFloats, prevLen);
                                    Log.d("BP2_RAW_ECG",
                                            "SampleRate=" + sampleRate + " Hz, mvPerCount=" + scale + ", floatsCount="
                                                    + ecgFloats.length + ", preview=" + Arrays.toString(preview));
                                }
                            } catch (Throwable ignore) {
                            }
                            synchronized (ecgLock) {
                                if (ecgShorts != null) {
                                    ...
                                    for (short s : ecgShorts)
                                        ecgAccumFloats.add((float) s);
                                } else {
                                    // If floats provided by SDK, pass through (may already be mV)
                                    for (float f : ecgFloats)
                                        ecgAccumFloats.add(f);
                                }
                                ...
                                if ((now - lastEcgEmitMs) >= 200 || ecgAccumFloats.size() >= 1000) {
                                    ...
                                    for (int i = 0; i < n; i++)
                                        wf.put((double) ecgAccumFloats.get(i));
                                    // drop what we sent
                                    for (int i = 0; i < n; i++)
                                        ecgAccumFloats.remove(0);
                                    lastEcgEmitMs = now;
                                    JSObject ecg = new JSObject();
                                    ecg.put("waveform", wf);
                                    if (hr != null)
                                        ecg.put("heartRate", hr);
    ...
    public void startRtTaskForConnectedDevice(PluginCall call) {
        try {
            ...
            if (activeWellueAddress != null) {
                ...
                if (m != null)
                    modelStr = String.valueOf(m.intValue());
            }
        ...
        try {
            ...
            try {
                ...
                for (java.lang.reflect.Method m : companion.getClass().getMethods()) {
                    if (m.getReturnType() == helper && m.getParameterCount() == 0
            ...
            if (bleHelperInstance != null) {
                Log.d(TAG,
                        "✅ BleServiceHelper instance created successfully: " + bleHelperInstance.getClass().getName());
            } else {
    ...
    public void load() {
        ...
        try {
            ...
            try {
                android.content.SharedPreferences sp = getContext().getSharedPreferences("wellue_prefs",
                ...
                if (last != null && !last.isEmpty()) {
                    ...
                    if (helper != null) {
                        ...
                        helper.getClass()
                                .getMethod("reconnectByAddress", Integer.class, String.class, boolean.class,
                                        boolean.class)
    ...
    private boolean ensurePermissions(PluginCall call) {
        // For Android 12+ we need BLUETOOTH_* runtime permissions; for <=11 we need
        // location
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    companion.getClass().getMethod("setInterfaces", int.class, boolean.class).invoke(companion,
                            Bluetooth.MODEL_BP2, true);
                    Log.d(TAG, "setInterfaces(BP2) via Companion OK");
                } catch (Throwable ignore) {
                    Object helper = getBleHelper();
                    if (helper != null) {
                        helper.getClass().getMethod("setInterfaces", int.class, boolean.class).invoke(helper,
                                Bluetooth.MODEL_BP2, true);
            ...
            try {
                ...
                if (systemScanner != null) {
                    ...
                    // But BP2 device may advertise different UUID:
    ...
    public void connect(PluginCall call) {
        try {
            ...
            // Restrict to a single active Wellue connection only (ignore other GATT devices
            // like earbuds/SPen)
            ...
            try {
                ...
                if (helper != null) {
                    ...
                    helper.getClass().getMethod("setInterfaces", int.class, boolean.class).invoke(helper, modelBp2,
                            true);
                    // connect(Context, int, BluetoothDevice, boolean, boolean)
                    helper.getClass()
                            .getMethod("connect", Context.class, int.class, android.bluetooth.BluetoothDevice.class,
    ...
    public void getBp2FileList(PluginCall call) {
        try {
            ...
            Observer<Object> obs = new Observer<Object>() {
                ...
                public void onChanged(Object obj) {
                    try {
                        Log.d(TAG, "📥 EventBp2FileList payload class="
                                + (obj != null ? obj.getClass().getName() : "null"));
                        ...
                        if (obj instanceof java.util.List) {
                            ...
                            if (list == null && obj.getClass().getName().contains("kotlin.Pair")) {
                                try {
                                    ...
                                    if (second instanceof java.util.List)
                                        list = (java.util.List<?>) second;
                                } catch (Throwable ignore) {
                                }
                            }
                        }
                        ...
                        try {
                            LiveEventBus.get(key, Object.class).removeObserver(this);
                        } catch (Throwable ignore) {
                        }
                    }
                }
            ...
            Object helper = getBleHelper();
            if (helper != null) {
                int model = activeWellueAddress != null
                        ? modelByAddress.getOrDefault(activeWellueAddress, com.lepu.blepro.objs.Bluetooth.MODEL_BP2)
                        : com.lepu.blepro.objs.Bluetooth.MODEL_BP2;
    ...
    public void readBp2File(PluginCall call) {
        try {
            ...
            Observer<Object> obs = new Observer<Object>() {
                ...
                public void onChanged(Object obj) {
                    try {
                        ...
                        if (obj != null) {
                            try {
                                Object v = obj.getClass().getMethod("getContent").invoke(obj);
                                if (v instanceof byte[])
                                    content = (byte[]) v;
                            } catch (Throwable ignore) {
                            }
                            try {
                                Object t = obj.getClass().getMethod("getType").invoke(obj);
                        ...
                        if (type != null)
                            out.put("type", type);
                        if (content != null)
                            out.put("base64", android.util.Base64.encodeToString(content, android.util.Base64.NO_WRAP));
                        call.resolve(out);
                    } catch (Throwable t) {
            ...
            Object helper = getBleHelper();
            if (helper != null) {
                helper.getClass().getMethod("bp2ReadFile", int.class, String.class).invoke(helper,
                        com.lepu.blepro.objs.Bluetooth.MODEL_BP2, name);
    ...
    // Aligned with TS bridge: expects { address, fileName } and returns { fileType,
    // fileContent }
    @PluginMethod
                    ...
                    try {
                        ...
                        if (payload != null) {
                            String[] unwrapMethods = new String[] {
                                    "getObj", "getData", "getPayload", "getSecond", "component2", "getFile",
                                    "getResponse"
                            };
                        ...
                        if (payload != null) {
                            try {
                                Object v = payload.getClass().getMethod("getContent").invoke(payload);
                                if (v instanceof byte[])
                                    content = (byte[]) v;
                            } catch (Throwable ignore) {
                            }
                            if (content == null) {
                                String[] contentMethods = new String[] { "getBytes", "getData", "bytes", "content",
                                        "getRaw" };
                            ...
                            // Type candidates
                            String[] typeMethods = new String[] { "getType", "getFileType", "getDataType", "getFormat",
                                    "type" };
                            for (String mn : typeMethods) {
                                try {
                                    Object t = payload.getClass().getMethod(mn).invoke(payload);
                                    if (t instanceof Integer) {
                                        type = (Integer) t;
                                        break;
                                    }
                            ...
                            // Name candidates
                            try {
                                Object n = payload.getClass().getMethod("getFileName").invoke(payload);
                                if (n != null)
                                    eventFileName = String.valueOf(n);
                            } catch (Throwable ignore) {
                            }
                            if (eventFileName == null) {
                                try {
                                    Object n = payload.getClass().getMethod("getName").invoke(payload);
                                    if (n != null)
                                        eventFileName = String.valueOf(n);
                                } catch (Throwable ignore) {
                                }
                            ...
                            try {
                                Object v = payload.getClass().getMethod("getSamplingRate").invoke(payload);
                                if (v instanceof Number)
                                    samplingRate = ((Number) v).intValue();
                            } catch (Throwable ignore) {
                            }
                            try {
                                Object v = payload.getClass().getMethod("getSampleRate").invoke(payload);
                                if (v instanceof Number)
                                    samplingRate = ((Number) v).intValue();
                            } catch (Throwable ignore) {
                            }
                            try {
                                Object v = payload.getClass().getMethod("getRecordingTime").invoke(payload);
                                if (v instanceof Number)
                                    recordingTimeSec = ((Number) v).intValue();
                            } catch (Throwable ignore) {
                            }
                            try {
                                Object v = payload.getClass().getMethod("getMeasureTime").invoke(payload);
                                if (v instanceof Number)
                                    measureTimeSec = ((Number) v).intValue();
                            } catch (Throwable ignore) {
                            }
                            try {
                                Object v = payload.getClass().getMethod("getDiagnosis").invoke(payload);
                                if (v != null)
                                    diagnosis = String.valueOf(v);
                            } catch (Throwable ignore) {
                            }
                            ...
                            if (samplingRate == null) {
                                ...
                                for (String rm : rateMethods) {
                                    try {
                                        Object v = payload.getClass().getMethod(rm).invoke(payload);
                                        if (v instanceof Number) {
                                            samplingRate = ((Number) v).intValue();
                                            break;
                                        }
                            ...
                            if (recordingTimeSec == null) {
                                String[] timeMethods = { "getDuration", "getLength", "getSeconds", "getTime",
                                        "getRecordTime" };
                                for (String tm : timeMethods) {
                                    try {
                                        Object v = payload.getClass().getMethod(tm).invoke(payload);
                                        if (v instanceof Number) {
                                            recordingTimeSec = ((Number) v).intValue();
                                            break;
                                        }
                            ...
                            if (measureTimeSec == null) {
                                String[] measureMethods = { "getMeasureDuration", "getMeasureLength",
                                        "getMeasureSeconds" };
                                for (String mm : measureMethods) {
                                    try {
                                        Object v = payload.getClass().getMethod(mm).invoke(payload);
                                        if (v instanceof Number) {
                                            measureTimeSec = ((Number) v).intValue();
                                            break;
                                        }
                            ...
                            if (diagnosis == null) {
                                ...
                                for (String dm : diagMethods) {
                                    try {
                                        Object v = payload.getClass().getMethod(dm).invoke(payload);
                                        if (v != null) {
                                            diagnosis = String.valueOf(v);
                                            break;
                                        }
                            ...
                            String[] waveNames = { "getWaveShortData", "getEcgShortData", "getShorts", "getEcgShorts",
                                    "getWaveData", "getEcgData", "getData", "getWaveform", "getEcgWaveform",
                                    "getRawData", "getSamples" };
                        ...
                        Log.d(TAG, "📦 Read complete for file='" + eventFileName + "' req='" + fileName + "' type="
                                + type + " bytes=" + (content != null ? content.length : 0));

                        // EXTENSIVE DEBUGGING: Log everything we received
                        Log.d(TAG, "🔍 DEBUG: Full payload object class="
                        ...
                        if (payload != null) {
                            ...
                            for (java.lang.reflect.Method m : payload.getClass().getMethods()) {
                                if (m.getParameterCount() == 0 && !m.getName().equals("getClass")
                                    ...
                                    try {
                                        ...
                                        Log.d(TAG, "  📋 " + m.getName() + "() -> " + result + " (type: "
                                                + (result != null ? result.getClass().getSimpleName() : "null") + ")");
                                    } catch (Throwable e) {
                            ...
                            String[] ecgMethods = { "getSamplingRate", "getSampleRate", "getRate", "getFrequency",
                                    "getHz", "getSamplesPerSecond", "getRecordingTime", "getDuration", "getLength",
                                    "getSeconds", "getTime", "getRecordTime", "getMeasureTime", "getMeasureDuration",
                                    "getDiagnosis", "getResult", "getConclusion", "getAnalysis", "getStatus" };
                            for (String methodName : ecgMethods) {
                                try {
                                    java.lang.reflect.Method m = payload.getClass().getMethod(methodName);
                                    Object result = m.invoke(payload);
                                    Log.d(TAG, "  🎯 " + methodName + "() -> " + result + " (type: "
                                            + (result != null ? result.getClass().getSimpleName() : "null") + ")");
                                } catch (Throwable e) {
                        ...
                        Log.d(TAG,
                                "🔍 DEBUG: Extracted metadata - type=" + type + ", sampleRate=" + samplingRate
                                        + ", recordingTime=" + recordingTimeSec + ", measureTime=" + measureTimeSec
                                        + ", diagnosis=" + diagnosis + ", waveShorts="
                                        + (waveShorts != null ? waveShorts.length : "null"));
                        ...
                        if (waveShorts != null && waveShorts.length > 0) {
                            ...
                            Log.d(TAG, "  📊 First 5 values: " + waveShorts[0] + ", " + waveShorts[1] + ", "
                                    + waveShorts[2] + ", " + waveShorts[3] + ", " + waveShorts[4]);
                            Log.d(TAG, "  📊 Last 5 values: " + waveShorts[waveShorts.length - 5] + ", "
                                    + waveShorts[waveShorts.length - 4] + ", " + waveShorts[waveShorts.length - 3]
                                    + ", " + waveShorts[waveShorts.length - 2] + ", "
                                    + waveShorts[waveShorts.length - 1]);
                        ...
                        if (samplingRate != null)
                            out.put("sampleRate", samplingRate.intValue());
                        if (recordingTimeSec != null)
                            out.put("recordingTimeSec", recordingTimeSec.intValue());
                        if (measureTimeSec != null)
                            out.put("measureTimeSec", measureTimeSec.intValue());
                        if (diagnosis != null)
                        ...
                        if (waveShorts != null && waveShorts.length > 0 && samplingRate == null) {
                            ...
                            for (int rate : commonRates) {
                                ...
                                if (estimatedDuration >= 10 && estimatedDuration <= 300) {
                                    Log.d(TAG, "🔍 DEBUG: Estimated sample rate: " + rate + " Hz (duration: "
                                            + estimatedDuration + "s)");
            ...
            if (helper != null) {
                try {
                    ...
                    if (idx != null) {
                        try {
                            int model = activeWellueAddress != null
                                    ? modelByAddress.getOrDefault(activeWellueAddress,
                                            com.lepu.blepro.objs.Bluetooth.MODEL_BP2)
                                    : com.lepu.blepro.objs.Bluetooth.MODEL_BP2;
    ...
    public void startECGMeasurement(PluginCall call) {
        try {
            ...
            JSObject ok = new JSObject();
            ok.put("success", true);
            ok.put("message", "ECG real-time started");
            call.resolve(ok);
        } catch (Exception e) {
    ...
    public void stopMeasurement(PluginCall call) {
        try {
            ...
            if (helper != null) {
                try {
                    helper.getClass().getMethod("bpmStop", int.class).invoke(helper,
                            com.lepu.blepro.objs.Bluetooth.MODEL_BP2);
                    Log.d(TAG, "⏹️ bpmStop(BP2) invoked");
                } catch (NoSuchMethodException nsme) {
                    try {
                        helper.getClass().getMethod("bp2StopMeasure").invoke(helper);
                        Log.d(TAG, "⏹️ bp2StopMeasure() invoked");
                    } catch (Throwable nested) {
                        Log.w(TAG, "No stop method found", nested);
                    }
                }
            ...
            JSObject ok = new JSObject();
            ok.put("success", true);
            ok.put("message", "Measurement stop requested");
            call.resolve(ok);
        } catch (Exception e) {
