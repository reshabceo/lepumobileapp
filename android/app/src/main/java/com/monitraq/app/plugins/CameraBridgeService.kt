...
import com.monitraq.app.MainActivity
import com.monitraq.app.R
...
class CameraBridgeService : Service() {
    ...
    companion object {
        const val ACTION_START = "com.monitraq.app.camera_bridge.START"
        const val ACTION_STOP = "com.monitraq.app.camera_bridge.STOP"
