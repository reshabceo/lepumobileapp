...
public class MainApplication extends Application {
    ...
    public void onCreate() {
        ...
        try {
            ...
            // SDK docs: initService(application) - Only need to initService once during app operation
            ...
            // Verify initialization - SDK will send EventServiceConnectedAndInterfaceInit when ready
            ...
            Log.e(TAG, "❌ CRITICAL: BleServiceHelper class not found - AAR file may be missing or not properly included");
