    ...
    <div className="min-h-screen bg-[#080D1A] text-white font-inter select-none p-4 pt-safe-top">
      <div className="max-w-4xl mx-auto pb-20">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-400">
                {!loading ? `${filtered.length} invoice${filtered.length !== 1 ? "s" : ""}` : "Loading invoices..."}
              </p>
            </div>
          </div>
        </header>
                ...
                <button
                  ...
                  className={`flex-shrink-0 px-3 py-1.5 rounded-full text-xs font-medium transition-all ${
                    activeTab === tab.key
                      ...
                      : "bg-[#1A243D] text-gray-400 border border-slate-700/40 hover:text-gray-200"
                  }`}
                >
                  {tab.label}
                  {count > 0 && (
        ...
        {!loading && filtered.length > 0 && (
          <div className="mb-4 px-4 py-3 bg-[#1A243D] border border-slate-700/40 shadow-sm rounded-2xl flex items-center justify-between">
